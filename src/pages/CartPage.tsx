    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="pt-32 text-center px-4">
          ...
          <h1 className="heading-display text-4xl font-bold mb-4">Cart is Empty</h1>
      ...
      <div className="pt-20 lg:pt-24">
        <div className="container mx-auto px-4 lg:px-8 py-10">
          <motion.h1
            ...
            className="heading-display text-4xl md:text-5xl font-bold mb-10"
          >
            Your Cart
          </motion.h1>
          ...
          <div className="grid lg:grid-cols-3 gap-10">
            <div className="lg:col-span-2 space-y-6">
              {items.map(item => (
                ...
                >
                  <Link to={`/product/${item.product.id}`} className="w-24 h-24 sm:w-32 sm:h-32 bg-card shrink-0 overflow-hidden border border-border">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <Link to={`/product/${item.product.id}`} className="block font-heading font-bold text-sm sm:text-base uppercase tracking-wide hover-neon transition-colors">{item.product.name}</Link>
            ...
            <div className="bg-card p-8 border border-border h-fit">
              ...
              <div className="flex justify-between font-heading text-xl font-bold mb-8">
                <span>Total</span>
                <span className="text-neon">{(cartTotal + shipping).toFixed(2)} KWD</span>
              </div>
              <button className="w-full bg-neon text-accent-foreground py-4 font-body text-sm font-bold tracking-wider uppercase glow-neon hover:bg-neon-glow transition-all duration-300 mb-3">
                Checkout
              </button>
