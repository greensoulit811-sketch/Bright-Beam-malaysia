    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-20 lg:pt-24">
        <div className="container mx-auto px-4 lg:px-8 py-10">
          <h1 className="heading-display text-4xl md:text-5xl font-bold mb-10 text-foreground">Wishlist</h1>
          {wishlistProducts.length > 0 ? (
            ...
            <div className="text-center py-20">
              ...
              <h2 className="heading-display text-3xl font-bold mb-4 text-foreground">No Saved Items</h2>
